<x-app-layout>
    <div class="container mx-auto p-6">
        <h1 class="text-3xl font-bold text-center text-blue-600 dark:text-white mb-6">Страница Todo</h1>
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4">
            <ul class="space-y-4">
                @foreach($tasks as $todo)
                <li class="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-900 rounded-lg shadow-sm">
                    <span class="text-xl text-gray-700 dark:text-white">{{ $todo->title }}</span>
            ...
            <div class="text-center mt-6">
                <a href="{{ route('tasks.create') }}" class="bg-blue-500 text-white text-xl text- px-4 py-2 rounded-lg hover:bg-blue-700 dark:hover:bg-gray-400 dark:bg-gray-900">
                    +
                </a>
            </div>
        </div>
